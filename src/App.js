            ...
            <div className="App">
              <table className="table table-striped table-hover table-bordered my-1">
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="col">
                      <p className="h6">cap.8.3: tabla.8.1 & cap.8.4</p>{" "}
                  ...
                  <tr>
                    <th scope="col">
                      <p className="h6">cap.8.6</p>Intervalos de confianza en
                      una muestra grande
                    </th>
                    <td>
                      <Link to="/icmg">
                  ...
                  <tr>
                    <th scope="col">
                      ...
                      <p>
                        Intervalos de confianza de una muestra pequeña para{" "}
                      </p>
                      <p>
                        <MathComponent
                          tex={String.raw`\mu \ \ y \ \ \mu_1 - \mu_2\ `}
                        />
                      </p>
                    </th>
                    <td>
